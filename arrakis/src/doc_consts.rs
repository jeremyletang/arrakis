...
pub const DOC_BASE: &'static str = "
<!DOCTYPE html>
<head>
  <title>Arrakis API documentation</title>
<style>
...
pub const TABLE_FOOTER: &'static str = "
  </tbody>
</table>
";

pub const DOC_END: &'static str = "
</article>
</body>
";
